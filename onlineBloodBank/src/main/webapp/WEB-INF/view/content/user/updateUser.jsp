...
<body>
	<f:form modelAttribute="user" action="updateRegisterSer">
		<table>
		<tr>
		<td colspan="2"><f:hidden path="id"/></td></tr>
			<tr>
			...
			<tr>
				...
				<td><f:select path="bGroup">
					...
					</f:select> <f:errors path="bGroup" cssClass="error" /></td>
			</tr>
			<tr>
				<td>Gender:</td>
				<td>Male <f:radiobutton path="gender" value="Male" /> Female <f:radiobutton
						path="gender" value="Female" /> <f:errors path="gender"
						cssClass="error" /></td>
			</tr>
			<tr>
				<td><label> Do you want to Become Donar : </label></td>
				<td><f:checkbox path="donor" value="yes" /> Yes <f:errors
						path="donor" cssClass="error" /></td>
			</tr>
			<tr>
